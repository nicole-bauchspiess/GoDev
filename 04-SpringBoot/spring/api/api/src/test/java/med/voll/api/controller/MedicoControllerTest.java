...
class MedicoControllerTest {
    ...
    //cria json sem ter que criar explicitamente
    @Autowired
    ...
    @Test
    @DisplayName("Deveria retornar código http 400 quando as informações forem inválidas")
    @WithMockUser // simula usuario logado
